...
#include "../counter7_h/counterone7.h"
#include "../counter7_h/countertwo7.h"
#include "../counter7_h/counterthree7.h"
#include "../counter7_h/counterfour7.h"
#include "../counter7_h/counterfive7.h"
#include "../counter7_h/countersix7.h"
#include "../counter7_h/counterseven7.h"
#include "../counter7_h/countereight7.h"
...
int main()
{
    ...
    for (int i = 0; i < size1; i++)
    {
        ...
        {
            counter[i][j] = counterone7[i][j] + countertwo7[i][j] + counterthree7[i][j] + counterfour7[i][j] + counterfive7[i][j] + countersix7[i][j] + counterseven7[i][j] + countereight7[i][j];
