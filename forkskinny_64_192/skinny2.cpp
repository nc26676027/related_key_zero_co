...
int main(int argc,char * argv[])
{
	...
	for(int round=0;round<r0;round++)
	{
		for(int pos=0;pos<16;pos++)
		{
			if(pos<8)
			{
				outcvc<<"ASSERT( RKin_"<<x_ROUND+round<<"_"<<pos<<" = 0bin0001 );"<<endl;
				outcvc<<"ASSERT( RKin2_"<<x_ROUND+round<<"_"<<pos<<" = 0bin0001 );"<<endl;
				outcvc<<"ASSERT( RKin3_"<<x_ROUND+round<<"_"<<pos<<" = 0bin0001 );"<<endl;
			}			
		}
	}
